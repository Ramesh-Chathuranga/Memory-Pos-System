...
import lk.pos.fx.shop.util.UserManager;
...
public class LoginFormController implements Initializable {
    ...
    public void loginTo(){
        String name=this.txtUser.getText().trim().toUpperCase().toString();
        String password=this.txtPassword.getText().trim().toString();
         if(UserManager.searchUsers(name)){
             int id = UserManager.getUserId(name, password);
             if(id >=0){
